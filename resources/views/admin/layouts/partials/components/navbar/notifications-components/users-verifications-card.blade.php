<div class="tab-pane fade" id="user-verifications" role="tabpanel">
    <div class="scroll-y mh-325px my-5 px-8">
        @if (count($notifications_collection['users_verifications']) > 0)
            @foreach ($notifications_collection['users_verifications'] as $notification)
                <div class="d-flex flex-stack py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mb-0 me-2">
                            <a href="{{ route('admin.users.show', ['user' => $notification->notifiable_target_id]) }}"
